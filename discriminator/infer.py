...
def infer():
    ...
    with torch.no_grad():
        ...
        for i in tqdm(range(len(dataset))):
            ...
            #print("summing over real  / img axes")
            ...
            #print("getting ready to calc heatmap")

            # Calculate the heatmap.
            if discriminator is not None and isinstance(
                discriminator, BaselineDiscriminator
            ):
                #print("successfully calculating heat map")
            ...
            #print("Do the final reconstruction ")
            ...
            if args.save_path:
                #print("save inference should happen")
                save_inference(
                    args.save_path,
                    torch.squeeze(rimg),
    ...
    if args.save_path and pos_values is not None and neg_values is not None:
        #print("only save data with blah blah")
        preds_data = {}
